...
Revision ID: 1726898d9ec3
Revises: 
Create Date: 2024-01-19 13:51:09.928233
...
def upgrade() -> None:
    ...
    op.create_table(
        "html_example",
        sa.Column("html_example", sa.String(), nullable=False),
        sa.Column("sense_id", sa.Integer(), nullable=False),
        sa.Column("id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["sense_id"],
